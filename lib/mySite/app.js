...
var App, bodyParser, cachelicious, cacheliciousConnect, cookieParser, express, favicon, fs, h5bp, http, livereload, logger, path, url, zlib;
  ...
  App.prototype.configure = function() {
    ...
    this.app.use((function(_this) {
      return function(req, res, next) {
        ...
        if (req.url[0] === '_' || req.url.indexOf('/_') >= 0) {
          return next();
        }
