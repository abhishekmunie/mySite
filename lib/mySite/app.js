...
module.exports.App = App = (function() {
  ...
  App.prototype.configure = function() {
    this.app.use(favicon(path.join(this.config.static_file.source, 'favicon.ico')));
    ...
    this.app.use(function(req, res, next) {
      res.status(404);
      req.url = '/404.html';
      return this.staticCache.apply(this, arguments);
    });
    ...
    if (this.app.get('env') === 'production') {
      return this.app.use(function(err, req, res, next) {
        ...
        if (req.xhr) {
          ...
          return res.send(err.status === 404 ? '404 Not Found' : 'Something blew up!');
        }
      });
