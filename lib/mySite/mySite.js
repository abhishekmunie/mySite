...
module.exports.Site = Site = (function() {
  ...
  function Site(options, callback) {
    var config_json, config_yml, e, unprocessed_options;
    ...
    try {
      config_json = grunt.file.readJSON(path.resolve(options.source, '_config.json'));
    } catch (_error) {
      e = _error;
    }
    ...
    configConvict.load(JSON.parse(grunt.template.process(JSON.stringify(unprocessed_options), {
      data: unprocessed_options
    })));
